...
const PodcastLayout = () => {
  return (
    <div className="grid grid-cols-2 gap-4 p-4 bg-black px-10 py-5">
      {/* Top Left */}
      <div className="rounded-3xl overflow-hidden rounded-tr-[10rem] rounded-tl-3xl rounded-bl-[5rem]">
        <Image
      ...
      {/* Top Right */}
      <div className="rounded-3xl overflow-hidden rounded-tl-[10rem] rounded-tr-[3rem] rounded-br-[3rem]">
        <Image
      ...
      {/* Bottom (Full Width) */}
      <div className="col-span-2 rounded-3xl overflow-hidden rounded-tl-[4rem] rounded-bl-[4rem rounded-tr-[10rem]">
        <Image
