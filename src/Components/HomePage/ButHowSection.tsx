...
const HowSection = () => {
  ...
  // Helper: wraps text in span with gradient class
  ...
  return (
    ...
    >
      <div className="flex items-center flex-col lg:flex-row gap-8 lg:gap-0 w-full max-w-[1400px] px-6 lg:px-12">
        {/* Left Character */}
        <div className="flex-shrink-0 w-64  md:w-[600px] lg:w-[700px] flex justify-center lg:justify-start lg:-mt-30 md:mt-40">
  <Image
    src={character}
    alt="Character"
    width={700}       
    height={650}      
    className="object-contain md:w-[650px] md:mt-10"
    priority
  />
</div>
        ...
        <div className="flex-1 absolute top-10 left-1/3 flex flex-col gap-6 lg:gap-4 lg:pl-2">
          {/* Title */}
          <h2 className="how-title text-center lg:text-left text-5xl md:text-6xl lg:text-7xl xl:text-9xl font-black tracking-wide leading-none gradient-stroke">
            BUT HOW ?
          </h2>

          {/* Subtitle */}
          <p className="how-subtitle text-center lg:text-left text-base md:text-lg lg:text-xl font-semibold uppercase tracking-wide gradient-strokes">
          ...
          {/* Play Sample */}
          <div className="how-play relative bottom-50 left-25 flex justify-center lg:justify-end">
