  ...
  useGSAP(() => {
    const tl = gsap.timeline({
      scrollTrigger: {
        ...
        start: "top bottom",   // when section is 70% from top of viewport
        end: "top center", // optional, controls duration of animation
  ...
  return (
    ...
    >
      <div className="flex items-center flex-col lg:flex-row gap-8 lg:gap-0 w-full max-w-[1400px] px-6 lg:px-12">
        {/* Left Character */}
        <div className="flex-shrink-0 lg:w-full flex justify-center lg:justify-start lg:-mt-30">
          <Image
            src={character}
            alt="Character"
            width={700}
        ...
        <div className="flex-1 absolute top-10 left-1/3 flex flex-col gap-6 lg:gap-4 lg:pl-2">
          {/* Title */}
          <h2 className="how-title text-center relative left-0 lg:text-left text-5xl md:text-6xl lg:text-7xl xl:text-9xl font-black tracking-wide leading-none">
            <span className="gradient-stroke">BUT HOW ?</span>
          </h2>

          {/* Subtitle */}
          <p className="how-subtitle text-center lg:text-left text-base md:text-lg lg:text-xl font-semibold uppercase tracking-wide">
